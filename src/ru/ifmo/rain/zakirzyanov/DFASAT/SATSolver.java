...
public class SATSolver {
	...
	public SATSolver(APTA apta, ConsistencyGraph cg, int colors) throws ContradictionException {
		this.apta = apta;
		this.cg = cg;
		this.colors = colors;
		this.maxVar = 1;
	...
	public Automat getModel() {
		...
		for (Entry<Integer, Integer> e : colorsOfNodes.entrySet()) {
			...
			for (Entry<String, Node> entry : apta.getNode(vertex).getChildren().entrySet()) {
